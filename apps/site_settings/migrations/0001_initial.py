    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary_color', models.CharField(blank=True, help_text='Deprecated: colors now come from the Themes app; kept for legacy templates.', max_length=7, null=True, validators=[django.core.validators.RegexValidator(message='Enter a valid hex color like #0d6efd', regex='^#(?:[A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$')])),
                ('secondary_color', models.CharField(blank=True, help_text='Deprecated: colors now come from the Themes app; kept for legacy templates.', max_length=7, null=True, validators=[django.core.validators.RegexValidator(message='Enter a valid hex color like #0d6efd', regex='^#(?:[A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$')])),
                ...
                ('featured_languages', models.CharField(blank=True, default='en,ar,fr,de,es,zh-hans,ja,ko,ru,pt', help_text='Comma-separated language codes to show in header (max 10). Other languages remain available via full selector.', max_length=200)),
                ...
                ('gmail_enabled', models.BooleanField(default=False, help_text='Use Gmail SMTP with an app password (recommended). When disabled, falls back to environment settings.')),
                ('gmail_username', models.EmailField(blank=True, default='', help_text='Gmail address used for SMTP AUTH.', max_length=254)),
                ('gmail_app_password', models.CharField(blank=True, default='', help_text='Gmail app password (never store your real password).', max_length=128)),
                ('gmail_from_email', models.EmailField(blank=True, default='', help_text='Optional From header. Defaults to gmail_username when empty.', max_length=254)),
                ...
                ('require_profile_completion', models.BooleanField(default=True, help_text='Require social auth users to complete profile before accessing the site')),
